...
{
	 var username = document.forms["insert"]["name"].value;
	 var email = document.forms["insert"]["email"].value;
	 var framework = document.forms["insert"]["frmaework"].value;
